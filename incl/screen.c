...
const eUSCI_SPI_MasterConfig spiMasterConfig =
{
    ...
    3000000,                                  // SMCLK = 12MHz (default) (Adjust if you changed clock)
    1500000,                                   // SPICLK = 6MHz (Fast enough for LCD)
...
void LCD_Init() {
    ...
    LCD_Data(0xC0);             // MY=1, MX=1 (Adjust this if screen is mirrored)
